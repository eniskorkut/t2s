/**
 * SVG Icons Component
 * Professional, minimal icons without emojis
 */
...
export function PinIcon({ className = '', size = 16 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 7 15.76V19a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-3.24a2 2 0 0 0 .89-1.31l.9-1.78a2 2 0 0 1 1.11-1.79L21 8.5a2 2 0 0 0 0-3.83l-4.5-1.8a2 2 0 0 1-1.11-1.79L15 1a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2l-.11.08a2 2 0 0 1-1.11 1.79L5 4.67a2 2 0 0 0 0 3.83L9 10.24z"></path>
    </svg>
  );
}
...
export function RefreshCwIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
